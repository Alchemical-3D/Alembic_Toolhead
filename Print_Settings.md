...
Below are the suggested values for a functional print between weight, strength, and print duration.
...
### Pro-Tips
- **Shrinkage Compensation:** If using ABS/ASA, remember to ensure your filament flow and scaling are dialed in so bearings and screws fit snugly without cracking the plastic, you can also print out a common 20mm cube to adjust your filament shrinkage as required.
